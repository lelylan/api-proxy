...
var routing = {
  ...
  '/consumptions':  { port: process.env.LELYLAN_DEVICES_PORT || 80,       host: process.env.LELYLAN_DEVICES_URL },
  '/histories':     { port: process.env.LELYLAN_DEVICES_PORT || 80,       host: process.env.LELYLAN_DEVICES_URL },
  ...
  '/locations':     { port: process.env.LELYLAN_LOCATIONS_PORT || 80,     host: process.env.LELYLAN_LOCATIONS_URL },
